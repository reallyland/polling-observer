...
```sh
# Install via NPM
$ npm install --save polling-observer
```
...
```js
const greeting = require('polling-observer');
```

#### Native ES modules or TypeScript

```ts
import greeting from 'polling-observer';
```
...
<!-- Badges -->
[follow-me-badge]: https://flat.badgen.net/twitter/follow/reallyland?icon=twitter
...
<!-- Links -->
[follow-me-url]: https://twitter.com/reallyland?utm_source=github.com&amp;utm_medium=referral&amp;utm_content=reallyland/polling-observer
...
[codacy-url]: https://www.codacy.com/app/reallyland/polling-observer?utm_source=github.com&amp;utm_medium=referral&amp;utm_content=reallyland/polling-observer&amp;utm_campaign=Badge_Grade
[coc-url]: https://github.com/reallyland/polling-observer/blob/master/CODE_OF_CONDUCT.md
